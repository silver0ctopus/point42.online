...
// Временный перехватчик для старых инлайновых onclick в HTML
window.interact = function(message) {
    console.log("Взаимодействие с объектом:", message || "Действие не назначено");
    
    // Если у тебя в HUD уже есть элемент для вывода системных сообщений, 
    // можно выводить текст туда. Пока просто пишем в консоль, чтобы не было ошибок.
};
